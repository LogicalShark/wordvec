...
# Danganronpa franchise characters grouped by installment
...
# Color of labels in each group (dark colors recommended, default black)
...
def makeModel(files, outputf, mode):
    ...
    if "big" in mode:
        ...
        model2 = Word2Vec(bigram_transformer[sentences], min_count=1)
...
def main():
    ...
    if "gen" in mode:
        ...
        outputf = input("Enter output filename ()\n")
